...
EIF_TYPED_VALUE F871_7118 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(870,194, Dtype(Current)));
	return r;
}
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 870, Current, 3, 0, 12642);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	for (;;) {
		...
		RTHOOK(7);
		ur1 = RTCCL(loc2);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(870, 196, dtype))(Current, ur1x);
		RTHOOK(8);
		RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 870, Current, 2, 1, 12643);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		RTHOOK(5);
		ur1 = RTCCL(loc1);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(870, 185, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		loc2 = RTCCL(tr1);
		...
		if (EIF_TEST(loc2)) {
			...
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(870, 24, dtype))(Current, ur1x);
			RTHOOK(7);
			RTDBGAA(Current, dtype, 870, 194, 0x10000000, 1); /* thumbs */
			
			(*(EIF_INTEGER_32 *)(Current + RTWA(870, 194, dtype)))++;
			RTHOOK(8);
			ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(870, 194, dtype));
