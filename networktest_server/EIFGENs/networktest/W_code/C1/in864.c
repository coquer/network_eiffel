...
extern EIF_TYPED_VALUE F864_6945(EIF_REFERENCE);
extern EIF_TYPED_VALUE F864_6946(EIF_REFERENCE);
extern EIF_TYPED_VALUE F864_6947(EIF_REFERENCE);
extern void F864_6948(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F864_6945 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 863, Current, 1, 0, 12480);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(863, Current, 12480);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(863, 35, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F864_6946)
EIF_TYPED_VALUE F864_6946 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 863, Current, 0, 0, 12481);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(863, Current, 12481);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F864_6947)
EIF_TYPED_VALUE F864_6947 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 863, Current, 0, 0, 12482);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(863, Current, 12482);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000361, 0,0); /* Result */
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {863,706,195,0xFFFF};
...
void F864_6948 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 863, Current, 0, 1, 12483);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(863, Current, 12483);
...
{
	GTCX
	RTOTS (6946,F864_6946)
	RTOTS (6947,F864_6947)
}
