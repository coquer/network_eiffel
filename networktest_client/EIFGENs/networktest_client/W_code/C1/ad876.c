...
extern void F876_7179(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ADDRINFO_2}.c_free */
void F876_7179 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 875, Current, 0, 1, 12701);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(875, Current, 12701);
	RTIV(Current, RTAL);
